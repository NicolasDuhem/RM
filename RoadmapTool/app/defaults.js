...
function sampleData() {
  ...
  const roadmapItems = [
    item('RM-0001', 'PRG-0001', 'Salesforce Accreditation Model', 'Salesforce accreditation',
      ...
      '2026-09-01', '2026-10-31', 'build', 'critical', 'Nicolas', {
        ...
        tasks: [
          task('TSK-0001', 'RM-0001', 'Create the accreditation object', 'build', 'Nicolas', '',
          ...
          task('TSK-0002', 'RM-0001', 'Migrate the accreditation spreadsheet', 'ready', 'Data team', 'data-platform',
            ['kr-customer-master'],
          ...
          task('TSK-0003', 'RM-0001', 'Publish accreditation to the platform', 'definition', 'Integration team', 'b2b',
            ['kr-order-errors'],
    ...
    item('RM-0002', 'PRG-0001', 'Platform Accreditation Matrix', 'Accreditation matrix',
      ...
      '2026-10-15', '2026-12-15', 'definition', 'high', 'Jake', {
        ...
        tasks: [
          task('TSK-0004', 'RM-0002', 'Matrix data model', 'definition', 'Jake', 'b2b',
            ['kr-order-errors'], [], { po: 2, dev: 6, int: 0, data: 1 },
            'Category to accreditation mapping with versioning.'),
          task('TSK-0005', 'RM-0002', 'Matrix maintenance screen', 'idea', 'Jake', 'b2b',
    ...
    item('RM-0003', 'PRG-0001', 'BPP Product Eligibility Restriction', 'BPP restriction',
      ...
      '2026-12-01', '2027-02-15', 'ready', 'high', 'Jake', {
        ...
        tasks: [
          task('TSK-0006', 'RM-0003', 'Catalogue filtering', 'ready', 'Jake', 'b2b',
            ['kr-order-errors'], [], { po: 2, dev: 9, int: 2, data: 0 },
            'Hide products the dealer is not accredited for.'),
          task('TSK-0007', 'RM-0003', 'Basket and order validation', 'idea', 'Jake', 'b2b',
    ...
    item('RM-0004', 'PRG-0002', 'Product Data Definition', 'Product data definition',
      ['data', 'pim'], 'Master data', ['discovery'], 'data-platform',
      '2026-09-15', '2026-11-30', 'discovery', 'high', 'Sarah', {
        ...
        tasks: [
          task('TSK-0008', 'RM-0004', 'Attribute catalogue workshops', 'discovery', 'Sarah', 'data-platform',
            ['kr-product-master'], [], { po: 8, dev: 0, int: 0, data: 2 },
            'Workshops per product family to agree the attribute list and owners.'),
          task('TSK-0009', 'RM-0004', 'Profile the current data', 'discovery', 'Data team', 'data-platform',
    ...
    item('RM-0005', 'PRG-0002', 'Translation Management Source', 'Translation source',
      ...
      '2026-11-01', '2027-01-31', 'idea', 'medium', 'Sarah', {
        ...
        tasks: [
          task('TSK-0010', 'RM-0005', 'Translation source decision', 'idea', 'Sarah', 'd2c',
            ['kr-time-to-publish'], [], { po: 4, dev: 0, int: 0, data: 0 },
            'Compare PIM-managed translation against the current process.'),
          task('TSK-0011', 'RM-0005', 'Publish translations to commerce', 'idea', 'Sarah', 'd2c',
    ...
    item('RM-0006', 'PRG-0002', 'PIM Evaluation', 'PIM evaluation',
      ['pim'], 'Tooling', ['discovery'], 'data-platform',
      '2027-01-01', '2027-03-31', 'idea', 'medium', 'Sarah', {
        ...
        tasks: [
          task('TSK-0012', 'RM-0006', 'Requirements and vendor long list', 'idea', 'Sarah', 'data-platform',
            ['kr-product-master'], [], { po: 6, dev: 0, int: 0, data: 1 }, '')
        ]
      }),

    item('RM-0007', 'PRG-0003', 'NetSuite Sales Order Integration', 'NetSuite orders',
      ['netsuite', 'integration'], 'Order to cash', ['integration'], 'netsuite-erp',
      '2026-09-01', '2026-11-30', 'build', 'critical', 'Jake', {
        ...
        tasks: [
          task('TSK-0013', 'RM-0007', 'Order payload mapping', 'build', 'Integration team', 'netsuite-erp',
            ['kr-no-rekeying'],
          ...
          task('TSK-0014', 'RM-0007', 'Error handling and retry', 'ready', 'Integration team', 'netsuite-erp',
            ['kr-no-rekeying'], [], { po: 1, dev: 4, int: 8, data: 0 },
            'Retry, alerting and a visible failure queue.'),
          task('TSK-0015', 'RM-0007', 'Tax per entity', 'definition', 'Finance', 'netsuite-erp',
    ...
    item('RM-0008', 'PRG-0003', 'NetSuite Stock Integration', 'NetSuite stock',
      ['netsuite', 'integration'], 'Inventory', ['integration'], 'netsuite-erp',
      '2026-10-15', '2026-12-15', 'definition', 'high', 'Jake', {
        ...
        tasks: [
          task('TSK-0016', 'RM-0008', 'Inventory feed', 'definition', 'Integration team', 'netsuite-erp',
            ['kr-availability'], [], { po: 2, dev: 6, int: 10, data: 2 },
            'Scheduled per-entity stock feed into the platform.'),
          task('TSK-0017', 'RM-0008', 'Availability calculation', 'idea', 'Jake', 'b2b',
    ...
    item('RM-0009', 'PRG-0003', 'USA Entity Rollout', 'USA rollout',
      ['bpp', 'netsuite'], 'Rollout', ['rollout'], 'b2b',
      '2026-12-01', '2027-02-28', 'ready', 'high', 'Jake', {
        ...
        tasks: [
          task('TSK-0018', 'RM-0009', 'Entity configuration', 'ready', 'Jake', 'b2b',
            ['kr-new-entities'], [], { po: 3, dev: 6, int: 4, data: 1 },
            'Pricing, tax, shipping and payment configuration for the USA entity.'),
          task('TSK-0019', 'RM-0009', 'Dealer onboarding', 'idea', 'Operations', 'shared',
    ...
    item('RM-0010', 'PRG-0003', 'Singapore Rollout', 'Singapore rollout',
      ...
      '2027-03-01', '2027-05-31', 'idea', 'medium', 'Jake', {
        ...
        tasks: [
          task('TSK-0020', 'RM-0010', 'Entity configuration', 'idea', 'Jake', 'b2b',
    ...
    item('RM-0011', 'PRG-0003', 'Japan Rollout', 'Japan rollout',
      ...
      '2027-05-01', '2027-08-31', 'idea', 'medium', 'Jake', {
        ...
        tasks: [
          task('TSK-0021', 'RM-0011', 'Entity configuration and translation', 'idea', 'Jake', 'b2b',
            ['kr-new-entities'], [], { po: 4, dev: 6, int: 5, data: 1 }, '')
        ]
      }),

    item('RM-0012', 'PRG-0004', 'Cross-entity Stock Visibility', 'Cross-entity stock',
      ['bpp', 'netsuite'], 'Availability', ['discovery'], 'b2b',
      '', '', 'idea', 'medium', 'Priya', {
  ...
  const resourceScenarios = [
    scenario('SCN-0001', 'Scenario A', 'Current team.', true, {
      ...
      'netsuite-erp': { po: 0.2, dev: 0.2, int: 0.5, data: 0.1 },
      csi: { po: 0.1, dev: 0.2, int: 0.1, data: 0 },
      'data-platform': { po: 0.2, dev: 0.2, int: 0.1, data: 0.5 },
      shared: { po: 0.3, dev: 0.2, int: 0.1, data: 0.1 }
    }),
    scenario('SCN-0002', 'Scenario B', 'Additional development and integration capacity from January.', false, {
      ...
      'netsuite-erp': { po: 0.5, dev: 0.5, int: 1, data: 0.2 },
      csi: { po: 0.2, dev: 0.5, int: 0.2, data: 0 },
      'data-platform': { po: 0.3, dev: 0.5, int: 0.2, data: 1 },
      shared: { po: 0.5, dev: 0.3, int: 0.2, data: 0.1 }
    })
  ];
